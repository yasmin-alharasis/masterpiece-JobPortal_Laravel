        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="salary">
                    <option value="200-500"{{$job->salary=='200-500'?'selected':''}}>200-500</option>
                    <option value="500-800"{{$job->salary=='500-800'?'selected':''}}>500-800</option>
                    <option value="800-1000"{{$job->salary=='800-1000'?'selected':''}}>800-1000</option>
                    <option value="1000-1200"{{$job->salary=='1000-1200'?'selected':''}}>1000-1200</option>
                    <option value="1200-1500"{{$job->salary=='1200-1500'?'selected':''}}>1200-1500</option>
                    <option value="2000 plus"{{$job->salary=='2000 plus'?'selected':''}}>2000 plus</option>
                </select>
            </div>
